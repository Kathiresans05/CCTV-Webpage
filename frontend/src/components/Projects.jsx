        ...
        <section id="projects" className="py-20 bg-gray-50 border-t border-gray-100">
            <div className="container mx-auto px-4 md:px-8">
                ...
                <div className="text-center max-w-2xl mx-auto mb-12">
                    <span className="text-red-700 font-bold uppercase tracking-wider text-[14px] mb-2 block">Our Portfolio</span>
                ...
                <div className="flex flex-wrap justify-center gap-2 md:gap-4 mb-12">
                    {categories.map((category, idx) => (
                        <button
                            ...
                            className={`px-4 md:px-6 py-2 rounded-full text-[14px] font-medium transition-all duration-300 ${activeTab === category
