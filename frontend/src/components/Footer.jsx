        ...
        <footer className="bg-[#0F172A] text-[#E5E7EB] border-t border-gray-800 pt-12 pb-6">
            <div className="container mx-auto px-4 md:px-8">
                    ...
                    <div>
                        <div className="flex items-center space-x-2 mb-4">
                            ...
                            <div className="flex flex-col">
                                <span className="font-bold text-lg text-white leading-tight">SKTECH</span>
                                <span className="text-[14px] text-[#EF4444] font-semibold tracking-wider uppercase">CCTV Solutions</span>
                            </div>
                        </div>
                        <p className="text-[14px] leading-relaxed text-[#E5E7EB]/70 max-w-xs">
                        ...
                        <ul className="space-y-3">
                            {[
                                ...
                                <li key={idx}>
                                    <a 
                                        href={link.path} 
                                        className="flex items-center space-x-2 text-white hover:text-[#EF4444] transition-colors duration-300 text-[14px] font-medium group"
                                    >
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start space-x-3">
                                ...
                                <span className="text-[14px] leading-relaxed">123 Security Avenue, Tech District, NY 10001</span>
                            </li>
                            <li className="flex items-center space-x-3">
                                <div className="bg-gray-800/50 p-1.5 rounded-lg">
                                    <Phone size={16} className="text-[#EF4444]" />
                                </div>
                                <span className="text-[14px]">+1 (800) 123-4567</span>
                            </li>
                            <li className="flex items-center space-x-3">
                                <div className="bg-gray-800/50 p-1.5 rounded-lg">
                                    <Mail size={16} className="text-[#EF4444]" />
                                </div>
                                <span className="text-[14px]">info@sktech.com</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="border-t border-gray-800/50 pt-6 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-[14px] text-[#E5E7EB]/50 mb-4 md:mb-0">
                        &copy; {new Date().getFullYear()} SKTECH CCTV Solutions. All rights reserved.
                    </p>
