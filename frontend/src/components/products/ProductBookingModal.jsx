...
import { X, CheckCircle, CreditCard, Banknote, MapPin, User, ChevronRight, Loader2, Package, ShieldCheck, Lock, Wallet, Smartphone, Landmark } from 'lucide-react';
                ...
                <div className="px-5 md:px-8 py-6 overflow-y-auto custom-scrollbar flex-grow">
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        onChange={(e) => {
                                            ...
                                            setEmailError(e.target.value.length > 0 && !isValidEmail(e.target.value));
                                        }}
                                        placeholder="john@example.com"
                                        className={`w-full px-4 py-3 bg-gray-50 border rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all outline-none text-gray-900 placeholder:text-gray-400 ${emailError ? 'border-red-300' : 'border-gray-200'}`}
                                    />
                                    {emailError && (
                    ...
                    {currentStep === 3 && (
                        <div className="animate-in fade-in slide-in-from-right-4 duration-500">
                            ...
                            <div className="space-y-3.5">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        <label className="block text-[14px] font-semibold text-gray-700 mb-1">Preferred Date <span className="text-red-500">*</span></label>
                                        <input 
                                            type="date" 
                                            value={addressData.preferredDate}
                                            onChange={(e) => setAddressData({...addressData, preferredDate: e.target.value})}
                                            className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-900 outline-none transition-all text-[14px] text-gray-900"
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-[14px] font-semibold text-gray-700 mb-1">Time Slot <span className="text-red-500">*</span></label>
                                        <select 
                                            value={addressData.timeSlot}
                                            onChange={(e) => setAddressData({...addressData, timeSlot: e.target.value})}
                                            className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-900 outline-none transition-all text-[14px] text-gray-900 appearance-none bg-[url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdib3g9IjAgMCAyMCAyMCIgZmlsbD0ibm9uZSI+PHBhdGggZD0iTTEwIDEybC01LTVoMTBsLTUgNXoiIGZpbGw9IiM2YjcyODAiLz48L3N2Zz4=')] bg-no-repeat bg-[center_right_10px] pr-8"
                                        >
                    ...
                    {currentStep === 4 && (
                        <div className="animate-in fade-in zoom-in-95 duration-500 text-center py-4">
                            ...
                            <p className="text-gray-500 text-[14px] mb-6">Your booking has been placed successfully.</p>
                                ...
                                <div className="space-y-2 text-[14px]">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-bold text-gray-900 uppercase">
                                            {paymentMethod === 'online' ? `Online (${onlineMethod})` : 'Cash on Delivery'}
                                        </span>
                                    </div>
